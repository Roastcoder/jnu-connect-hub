...
export const Route = createFileRoute("/admin/certificates")({ component: CertificatesPage });
  ...
  return (
    <CrudTable<Row>
      ...
      columns={[
        ...
        { key: "issued_at", label: "Issued", render: (r) => <span className="text-xs text-muted-foreground">{new Date(r.issued_at).toLocaleDateString()}</span> },
      ]}
    />
  );
}
